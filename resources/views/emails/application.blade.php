                            ...
                            <tr>
                                <td valign="top" style="vertical-align: top;">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" align="center">
                                        <tr>
                                            <td valign="top" style="vertical-align: top;">
                                                <span style=""><h3>JVEquipment Employment Application</h3></span>
                                                <span style=""><span class="label" style="width: 100px; font-weight: bold; display:inline-block">Position: </span><span class="value">{{$Position}}</span></span><br>
                                                <span style=""><span class="label" style="width: 100px; font-weight: bold; display:inline-block">City: </span><span class="value">{{$City}}</span></span><br>
                                                <span style=""><span class="label" style="width: 100px; font-weight: bold; display:inline-block">State: </span><span class="value">{{$State}}</span></span><br>
                                            </td>
                                        </tr>
                                    </table>
                                    <table cellpadding="0" cellspacing="0" border="0" align="center">
