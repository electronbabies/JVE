                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" align="center" style="margin-bottom: 20px;">
                                        <tr>
                                            <td valign="top" style="vertical-align: top;">
                                                ...
                                                <span style=""><span class="label" style="width: 100px; font-weight: bold; display:inline-block">Environment: </span><span class="value">{{$Environment}}</span></span><br>
                                                <span style=""><span class="label" style="width: 100px; font-weight: bold; display:inline-block">Motive Power: </span><span class="value">{{$MotivePower}}</span></span><br>
                                                <span style=""><span class="label" style="width: 100px; font-weight: bold; display:inline-block">Capacity: </span><span class="value">{{$Capacity}}</span></span><br>
                                                <span style=""><span class="label" style="width: 100px; font-weight: bold; display:inline-block">Attachment: </span><span class="value">{{$Attachment}}</span></span><br>
                                                <span style=""><span class="label" style="width: 100px; font-weight: bold; display:inline-block">Operating Hours: </span><span class="value">{{$OperatingHours}}</span></span><br>
                                                <span style=""><span class="label" style="width: 100px; font-weight: bold; display:inline-block">Accessories: </span><span class="value">&nbsp;</span></span><br>
                                                @foreach($Accessories as $Accessory)
                                                    <span style=""><span class="label" style="width: 100px; font-weight: bold; display:inline-block">&nbsp;</span><span class="value">{{$Accessory}}</span></span><br>
                                                @endforeach
                                                <span style=""><span class="label" style="width: 100px; font-weight: bold; display:inline-block">Comments: </span><span class="value">{{$Comments}}</span></span>
                                            </td>
                                        </tr>
                                    </table>
