<header class="navbar-fixed-top">
  ...
  <nav class="navbar navbar-default navbar-fixed-top navmobile" id="nav">
    ...
    <div class="container relative-nav-container">
      ...
      <a href="/" class="nav-logo scroll"> <img alt="logo" src="/img/logo-color.png" class="logo hidden-xs"> <img alt="logo" src="/img/logo-white.png" class="logoColor hidden-xs"> <img alt="logo" src="/img/logo-color.png" class="visible-xs-block"> </a>
      <div id="navbar-collapse" class="navbar-collapse collapse floated">
        <ul class="nav navbar-nav navbar-with-inside clearfix navbar-right with-border">
			...
			@if($CareerCount > 0)<li><a href="/careers">Careers</a></li>@endif
