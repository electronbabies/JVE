                                                    ...
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                ...
                                                                <div class="text-center">
                                                                    <a href="/forms/service" class="a-btn">Get Started Now!</a>
                                                                </div>
                                                                <div class="text-center">
                                                                    <a href="/forms/service" class="btn btn-sq btn-d btn-glossy">Request Service Quote</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="panel">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="text-center">
                                                            <a href="/forms/parts" class="a-btn">Get Started Now!</a>
                                                        </div>
                                                        <div class="text-center">
                                                            <a href="/forms/parts" class="btn btn-sq btn-d btn-glossy">Request Parts Quote</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="panel">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="text-center">
                                                            <a href="/forms/sales" class="a-btn">Get Started Now!</a>
                                                        </div>
                                                        <div class="text-center">
                                                            <a href="/forms/sales" class="btn btn-sq btn-glossy btn-d">Request Sales Quote</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="panel">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="text-center">
                                                            <a href="/forms/rental" class="a-btn">Get Started Now!</a>
                                                        </div>
                                                        <div class="text-center">
                                                            <a href="/forms/rental" class="btn btn-sq btn-d btn-glossy">Request Rental Quote</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
