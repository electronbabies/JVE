...
<section class="parts-quote wrap parts-quote-bg" style="background-color: #00AFF0;">
  <div class="container wrap-xl sales-header-div" style="padding: 150px;padding-bottom: 0px;">
    <div class="row">
      <div class="col-sm-12">
        <div class="row">
          <div class="col-sm-12 text-center" style="margin-top: 35px;">
            <h2 class="text-center mg-sm" style="color: white;">Sales Quote</h2>
            <h3 class="text-center mg-lg"> <span style="color: white;">Contact us today about your sales quote</span> </h3>  </div>
        </div>
      </div>
    </div>
  </div>
