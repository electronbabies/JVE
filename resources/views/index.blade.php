    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="row wow fadeInUp" data-wow-delay="1.4s" data-wow-duration="0.6s">
          <div class="col-md-6"> <a class="btn btn-primary">Get a Quote</a> </div>
          <div class="col-md-6"> <a class="btn btn-primary">View Our Inventory</a> </div>
        </div>
      </div>
      <div class="col-md-5" style="float: right; margin: 0px !important; padding: 0px !important">
